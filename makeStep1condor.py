...
relbase = '/uscms_data/d3/rsyarif/Spring2016/TprimeFakeRateReproduce/FromJulie/CMSSW_7_4_14/'
inputDir='/eos/uscms/store/user/lpcljm/LJMet_FakeRateTest_MC/'+shift+'/'
if 'JSF' in shift:
    inputDir='/eos/uscms/store/user/lpcljm/LJMet_1lepTT_022916/nominal/'
outputDir='/eos/uscms/store/user/lpcljm/LJMet_FakeRateTest_MC_step1/'+shift+'/'
condorDir='/uscms_data/d3/rsyarif/Spring2016/TprimeFakeRateReproduce/LJMet_FakeRateTest_MC_step1/'+shift+'/'
...
runDir=os.getcwd()
if 'BTAG' not in shift: runDirPost = ''
